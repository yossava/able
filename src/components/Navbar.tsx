...
export default function Navbar() {
  ...
  return (
    <header
      id="navbar"
      className="bg-transparent text-white text-lg fixed top-0 left-0 right-0 z-50 flex justify-center"
    >
      <div className="container bg-transparent">
        <nav className="bg-transparent flex justify-between items-center py-2">
          <a
            className="text-xl font-semibold leading-none bg-white/80 rounded p-3 "
            href="/"
          >
            <Image
              width={200}
